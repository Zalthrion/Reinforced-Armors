...
public class ItemBoneArmor extends ItemArmor {
	...
	public ItemBoneArmor(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
...
//	player.addPotionEffect(new PotionEffect(Potion.weakness.id, 2, 0));
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == Item.bone; //Allows certain items to repair this armor.
