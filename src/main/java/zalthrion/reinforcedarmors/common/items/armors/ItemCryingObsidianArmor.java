...
public class ItemCryingObsidianArmor extends ItemArmor {
	...
	//(Potion Effects.)
		...
		public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
		  ...
		  return stack.getItem() == ModItems.CryingObsidian_Ingot; //Alllows certain items to repair this armor.
...
//		par2List.add("\u00a7o" + "Crying Obsidian Ingots");
		par2List.add("Crying Obsidian Ingots");
		}
