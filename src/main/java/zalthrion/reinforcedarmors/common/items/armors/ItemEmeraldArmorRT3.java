...
public class ItemEmeraldArmorRT3 extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemEmeraldArmorRT3(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
...
//	if(this == ReinforcedArmors.Reinforced_Emerald_Helmet_T3)
...
//		if(ReinforcedArmors.Reinforced_Emerald_Helmet_T3 != null)
//		if(ReinforcedArmors.Reinforced_Emerald_Chestplate_T3 != null)
//		if(ReinforcedArmors.Reinforced_Emerald_Leggings_T3 != null)
//	    if(ReinforcedArmors.Reinforced_Emerald_Boots_T3 != null)
...
//	player.addPotionEffect(new PotionEffect(Potion.weakness.id, 0, 0));
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == ModItems.Reinforced_Emerald; //Allows certain items to repair this armor.
