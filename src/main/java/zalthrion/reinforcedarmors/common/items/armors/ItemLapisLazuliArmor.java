...
public class ItemLapisLazuliArmor extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemLapisLazuliArmor(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
...
//	player.addPotionEffect(new PotionEffect(Potion.weakness.id, 2, 0));
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == ModItems.LapisLazuli_Ingot; //Allows certain items to repair this armor.
