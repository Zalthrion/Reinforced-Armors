...
public class ItemLapisLazuliArmorRT2 extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemLapisLazuliArmorRT2(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
