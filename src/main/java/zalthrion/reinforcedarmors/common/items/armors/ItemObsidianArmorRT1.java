...
public class ItemObsidianArmorRT1 extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemObsidianArmorRT1(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == ModItems.Obsidian_Crystal; //Alllows certain items to repair this armor.
...
//	par2List.add("\u00a7o" + "Obsidian Crystals");
	par2List.add("Obsidian Crystals");
	}
