...
public class ItemQuartzArmorRT1 extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemQuartzArmorRT1(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
...
//	player.addPotionEffect(new PotionEffect(Potion.weakness.id, 2, 0));
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == ModItems.Hardened_Quartz_Shard; //Allows certain items to repair this armor.
...
//	par2List.add("\u00a7o" + "Lapis Lazuli Ingots");
	par2List.add("Hardened Quartz Shard");
	}
