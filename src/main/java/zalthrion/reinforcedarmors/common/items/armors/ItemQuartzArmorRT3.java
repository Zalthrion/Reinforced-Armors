...
public class ItemQuartzArmorRT3 extends ItemArmor {

	private String texturePath = "reinforcedarmors" + ":" + "textures/models/armors/";
	
	public ItemQuartzArmorRT3(int par1, EnumArmorMaterial armorMaterial, int par3, int par4, String type) {
...
//	player.addPotionEffect(new PotionEffect(Potion.weakness.id, 0, 0));
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack) {
	  ...
	  return stack.getItem() == ModItems.Purified_Quartz_Shard; //Allows certain items to repair this armor.
...
//	par2List.add("\u00a7o" + "Purified Quartz Shards");
	par2List.add("Purified Quartz Shards");
	}
